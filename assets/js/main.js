class ValidaForm {
    ...
    senhasSaoValidas() {
        ...
        if(senha.value !== confirmaSenha.value) {
            valid = false;
            this.criaErro(senha, 'O campo de senha e confirmação de senha precisam ser iguais.');
            this.criaErro(confirmaSenha, 'O campo de senha e confirmação de senha precisam ser iguais.');
        }
